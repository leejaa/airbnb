...
var RoomCard = function RoomCard(_ref) {
  ...
  return __jsx("div", {
    ...
    style: {
      ...
      cursor: 'pointer',
      boxShadow: "".concat(isHoverArrow ? '1.5px 1.5px 1.5px 1.5px gray' : '')
    },
    onMouseOver: function onMouseOver() {
      return setIsHoverArrow(true);
    },
    onMouseLeave: function onMouseLeave() {
      return setIsHoverArrow(false);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
...
//# sourceMappingURL=index.js.387436d8b3d1ccaf68aa.hot-update.js.map