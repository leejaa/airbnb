...
var CreateRoom = function CreateRoom(_ref) {
  ...
  var onDateSelect = Object(react__WEBPACK_IMPORTED_MODULE_4__["useCallback"])(function (date) {
    ...
    console.log('current', moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD'));

    if (lodash__WEBPACK_IMPORTED_MODULE_8___default.a.some(selectedDates, moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD'))) {
      console.log('111');
...
//# sourceMappingURL=createRoom.js.b892404cff44bf0af317.hot-update.js.map