...
var CreateRoom = function CreateRoom(_ref) {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_4__["useContext"])(_pages_createRoom__WEBPACK_IMPORTED_MODULE_12__["CreateRoomContext"]),
      state = _useContext[0],
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function setCurrentLocation$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_10___default.a.post('https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyBBT02YSLxubEfcSxZA9UIiqy3rxD0pHfc'));
          ...
          case 2:
            ...
            _context.next = 7;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_10___default.a.get("https://maps.googleapis.com/maps/api/geocode/json?latlng=".concat(lat, ",").concat(lng, "&key=AIzaSyBBT02YSLxubEfcSxZA9UIiqy3rxD0pHfc")));
  ...
  var onDateSelect = Object(react__WEBPACK_IMPORTED_MODULE_4__["useCallback"])(function (date) {
    var newSelectedDates = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.clone(selectedDates);

    if (lodash__WEBPACK_IMPORTED_MODULE_9___default.a.includes(selectedDates, moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD'))) {
      newSelectedDates = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.pull(selectedDates, moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD'));
    } else {
      newSelectedDates = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.union(selectedDates, [moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD')]);
    }
  ...
  var dateFullCellRender = Object(react__WEBPACK_IMPORTED_MODULE_4__["useCallback"])(function (date) {
    ...
    return __jsx("div", {
      ...
      style: lodash__WEBPACK_IMPORTED_MODULE_9___default.a.includes(selectedDates, moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('YYYY-MM-DD')) ? overrideStyle : {},
      __source: {
...
//# sourceMappingURL=createRoom.js.446a90e5caafc8f8bc2e.hot-update.js.map