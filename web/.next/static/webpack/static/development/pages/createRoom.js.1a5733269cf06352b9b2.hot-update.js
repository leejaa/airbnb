...
/* harmony import */ var _assets_scss_room_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../assets/scss/room.scss */ "./assets/scss/room.scss");
/* harmony import */ var _assets_scss_room_scss__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_assets_scss_room_scss__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _pages_createRoom__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../pages/createRoom */ "./pages/createRoom.tsx");
/* harmony import */ var _ImageUpload__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ImageUpload */ "./components/ImageUpload.tsx");
...
var CreateRoom = function CreateRoom(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(6),
      step = _useState[0],
      setStep = _useState[1];
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(_pages_createRoom__WEBPACK_IMPORTED_MODULE_12__["CreateRoomContext"]),
      state = _useContext[0],
  ...
  var tempSave = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function () {
    window.localStorage.setItem('state', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(state));
  }, [state]);
  var onChange = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (e) {
    dispatch({
      type: 'setConvenience',
      value: e.target.value
    });
  }, [state]);
  var goPrevStep = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function () {
    var newStep = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.clone(step);

    setStep(--newStep);
  }, [step]);
  var goNextStep = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function () {
    var newStep = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.clone(step);

    setStep(++newStep);
  }, [step]);
  var onChageRule = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (e) {
    setRule(e.target.value);
    console.log('rule', rule);
  }, [rule]);
  var addRules = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (e) {
    var newRules = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.union(rules, [rule]);

    setRules(newRules);
    setRule("");
  }, [rules, rule]);
  var removeRule = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (index) {
    var newRules = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.clone(rules);

    lodash__WEBPACK_IMPORTED_MODULE_9___default.a.pullAt(newRules, [index]);

    setRules(newRules);
  }, [rules]);
  var options = Object(react__WEBPACK_IMPORTED_MODULE_5__["useMemo"])(function () {
    var option = {
      center: {
        lat: state.lat,
        lng: state.lng
  ...
  var links = Object(react__WEBPACK_IMPORTED_MODULE_5__["useMemo"])(function () {
    return [{
      coords: {
        lat: state.lat,
        lng: state.lng
  ...
  var setCurrentLocation = function setCurrentLocation() {
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.async(function setCurrentLocation$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_10___default.a.post('https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyBBT02YSLxubEfcSxZA9UIiqy3rxD0pHfc'));
          ...
          case 2:
            ...
            _context.next = 7;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_10___default.a.get("https://maps.googleapis.com/maps/api/geocode/json?latlng=".concat(lat, ",").concat(lng, "&key=AIzaSyBBT02YSLxubEfcSxZA9UIiqy3rxD0pHfc")));

          case 7:
            locationInfo = _context.sent;
            results = locationInfo.data.results;

            if (!lodash__WEBPACK_IMPORTED_MODULE_9___default.a.isEmpty(results)) {
  ...
  var addFile = function addFile(file) {
    ...
    setFiles({
      files: file.map(function (file) {
        return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()(file, {
          preview: URL.createObjectURL(file)
        });
      })
    });
  ...
  var setDisableDate = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (current) {
    return current && current < moment__WEBPACK_IMPORTED_MODULE_8___default()().endOf('day');
  }, []);
  var onDateSelect = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(function (date) {
    var newSelectedDates = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.union(selectedDates, [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(selectedDates), [moment__WEBPACK_IMPORTED_MODULE_8___default()(date).format('YYYY-MM-DD')]));

    console.log('newSelectedDates', newSelectedDates);
  }, [selectedDates]);
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    return function () {
      var newFiles = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.clone(files);
  ...
  var content = Object(react__WEBPACK_IMPORTED_MODULE_5__["useMemo"])(function () {
    return __jsx("div", {
      __source: {
  ...
  return __jsx("div", {
    ...
    type: "checkbox",
    className: "w-8",
    checked: lodash__WEBPACK_IMPORTED_MODULE_9___default.a.includes(state.convenience, 'aircon'),
    value: "aircon",
    onChange: onChange,
    __source: {
      fileName: _jsxFileName,
    ...
    type: "checkbox",
    className: "w-8",
    checked: lodash__WEBPACK_IMPORTED_MODULE_9___default.a.includes(state.convenience, 'refrigerator'),
    value: "refrigerator",
    onChange: onChange,
    __source: {
      fileName: _jsxFileName,
    ...
    type: "checkbox",
    className: "w-8",
    checked: lodash__WEBPACK_IMPORTED_MODULE_9___default.a.includes(state.convenience, 'washer'),
    value: "washer",
    onChange: onChange,
    __source: {
      fileName: _jsxFileName,
    ...
    type: "text",
    placeholder: "\uC2DC/\uB3C4",
    value: !lodash__WEBPACK_IMPORTED_MODULE_9___default.a.isEmpty(state.address) ? "".concat(state.address[2], " ").concat(state.address[3]) : '',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 232
    },
    ...
    type: "text",
    placeholder: "\uC2DC/\uAD70/\uAD6C",
    value: !lodash__WEBPACK_IMPORTED_MODULE_9___default.a.isEmpty(state.address) ? "".concat(state.address[4]) : '',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 236
    },
    ...
    type: "text",
    placeholder: "\uB3C4\uB85C\uBA85\uC8FC\uC18C",
    value: !lodash__WEBPACK_IMPORTED_MODULE_9___default.a.isEmpty(state.address) ? "".concat(state.address[0], " ").concat(state.address[1], " ").concat(state.address[2], " ").concat(state.address[3], " ").concat(state.address[4]) : '',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 244
    },
    ...
    __self: this
  }) : __jsx(_ImageUpload__WEBPACK_IMPORTED_MODULE_13__["ImageUpload"], {
    state: state,
    dispatch: dispatch,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, "\uC5B4\uB9B0\uC774 \uC219\uBC15\uC5D0 \uC801\uD569\uD568"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Popover"], {
    content: content,
    title: "Title",
    placement: "right",
    __source: {
    ...
    __self: this
  }, __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Calendar"], {
...
//# sourceMappingURL=createRoom.js.1a5733269cf06352b9b2.hot-update.js.map