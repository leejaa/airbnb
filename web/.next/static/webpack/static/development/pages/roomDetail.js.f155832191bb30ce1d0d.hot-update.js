...
var RoomImages = function RoomImages(_ref) {
  ...
  return __jsx("div", {
    ...
    style: {
      display: "".concat(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.includes(brightList, 1) ? 'inline' : 'none')
    },
    ...
    style: {
      display: "".concat(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.includes(brightList, 2) ? 'inline' : 'none')
    },
    onMouseOver: function onMouseOver() {
    ...
    style: {
      display: "".concat(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.includes(brightList, 3) ? 'inline' : 'none')
    },
    onMouseOver: function onMouseOver() {
    ...
    className: "roomimages-container4_2",
    style: {
      display: "".concat(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.includes(brightList, 4) ? 'inline' : 'none')
    },
    onMouseOver: function onMouseOver() {
    ...
    className: "roomimages-container4_3",
    style: {
      display: "".concat(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.includes(brightList, 5) ? 'inline' : 'none')
    },
    onMouseOver: function onMouseOver() {
...
//# sourceMappingURL=roomDetail.js.f155832191bb30ce1d0d.hot-update.js.map