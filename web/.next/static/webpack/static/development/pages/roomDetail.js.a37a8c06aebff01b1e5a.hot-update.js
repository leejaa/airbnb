...
var Calendars = function Calendars(_ref) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(moment.range(moment(), moment())),
      dates = _useState2[0],
      setDates = _useState2[1];

  var dateFullCellRender = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (dateParam) {
    console.log("date: ".concat(date.format('YYYY-MM-DD'), " / dateParam : ").concat(dateParam.format('YYYY-MM-DD'), " / result : ").concat(date.isAfter(dateParam)));
...
//# sourceMappingURL=roomDetail.js.a37a8c06aebff01b1e5a.hot-update.js.map