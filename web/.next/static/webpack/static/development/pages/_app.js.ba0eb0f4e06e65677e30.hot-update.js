...
/* harmony import */ var apollo_link_context__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! apollo-link-context */ "./node_modules/apollo-link-context/lib/bundle.esm.js");
/* harmony import */ var isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! isomorphic-unfetch */ "./node_modules/next/dist/build/polyfills/fetch/index.js");
...
/* harmony import */ var apollo_link_token_refresh__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! apollo-link-token-refresh */ "./node_modules/apollo-link-token-refresh/lib/tokenRefreshLink.js");
...
/* harmony import */ var _accessToken__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./accessToken */ "./lib/accessToken.ts");
/* harmony import */ var apollo_link_error__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! apollo-link-error */ "./node_modules/apollo-link-error/lib/bundle.esm.js");
...
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! cookie */ "./node_modules/cookie/index.js");
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(cookie__WEBPACK_IMPORTED_MODULE_24__);
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../env */ "./env.ts");
...
function withApollo(PageComponent) {
  ...
  var WithApollo = function WithApollo(_ref2) {
    var apolloClient = _ref2.apolloClient,
        ...
        pageProps = Object(_babel_runtime_corejs2_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_11__["default"])(_ref2, ["apolloClient", "serverAccessToken", "apolloState"]);

    if (!isServer() && !Object(_accessToken__WEBPACK_IMPORTED_MODULE_21__["getAccessToken"])()) {
      Object(_accessToken__WEBPACK_IMPORTED_MODULE_21__["setAccessToken"])(serverAccessToken);
    }

    var client = apolloClient || initApolloClient(apolloState);
    return __jsx(PageComponent, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_10__["default"])({}, pageProps, {
      apolloClient: client,
      __source: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              cookies = cookie__WEBPACK_IMPORTED_MODULE_24___default.a.parse("".concat(req.headers.cookie));
              ...
              _context.next = 7;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.awrap(isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_18___default()(_env__WEBPACK_IMPORTED_MODULE_25__["IS_PRODUCTION"] ? "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_PRODUCTION"], "/refresh_token") : "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_DEVELOPMENT"], "/refresh_token"), {
                method: "POST",
                credentials: "include",
                headers: {
            ...
            case 10:
              data = _context.sent;
              console.log('data', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_9___default()(data));
            ...
            case 38:
              ...
              next_head__WEBPACK_IMPORTED_MODULE_13___default.a.rewind();
...
function createApolloClient() {
  ...
  var httpLink = new apollo_link_http__WEBPACK_IMPORTED_MODULE_16__["HttpLink"]({
    uri: _env__WEBPACK_IMPORTED_MODULE_25__["IS_PRODUCTION"] ? "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_PRODUCTION"], "/graphql") : "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_DEVELOPMENT"], "/graphql"),
    credentials: "include",
    fetch: isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_18___default.a
  });
  var refreshLink = new apollo_link_token_refresh__WEBPACK_IMPORTED_MODULE_19__["TokenRefreshLink"]({
    accessTokenField: "accessToken",
    isTokenValidOrUndefined: function isTokenValidOrUndefined() {
      var token = Object(_accessToken__WEBPACK_IMPORTED_MODULE_21__["getAccessToken"])();
      ...
      try {
        var _jwtDecode = jwt_decode__WEBPACK_IMPORTED_MODULE_20___default()(token),
            exp = _jwtDecode.exp;
    ...
    fetchAccessToken: function fetchAccessToken() {
      return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_18___default()(_env__WEBPACK_IMPORTED_MODULE_25__["IS_PRODUCTION"] ? "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_PRODUCTION"], "/refresh_token") : "".concat(_env__WEBPACK_IMPORTED_MODULE_25__["API_DEVELOPMENT"], "/refresh_token"), {
        method: "POST",
        credentials: "include"
      });
    },
    handleFetch: function handleFetch(accessToken) {
      Object(_accessToken__WEBPACK_IMPORTED_MODULE_21__["setAccessToken"])(accessToken);
    },
  ...
  var authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_17__["setContext"])(function (_request, _ref4) {
    var headers = _ref4.headers;
    var token = isServer() ? serverAccessToken : Object(_accessToken__WEBPACK_IMPORTED_MODULE_21__["getAccessToken"])();
    return {
  ...
  var errorLink = Object(apollo_link_error__WEBPACK_IMPORTED_MODULE_22__["onError"])(function (_ref5) {
  ...
  return new apollo_client__WEBPACK_IMPORTED_MODULE_14__["ApolloClient"]({
    ...
    link: apollo_link__WEBPACK_IMPORTED_MODULE_23__["ApolloLink"].from([refreshLink, authLink, errorLink, httpLink]),
...
//# sourceMappingURL=_app.js.ba0eb0f4e06e65677e30.hot-update.js.map